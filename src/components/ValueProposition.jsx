...
export default function ValueProposition() {
  ...
  const features = [
    { icon: icons[0], title: t('value', 'f1title'), text: t('value', 'f1text') },
    { icon: icons[1], title: t('value', 'f2title'), text: t('value', 'f2text') },
    { icon: icons[2], title: t('value', 'f3title'), text: t('value', 'f3text') },
    { icon: icons[3], title: t('value', 'f4title'), text: t('value', 'f4text') },
  ]
